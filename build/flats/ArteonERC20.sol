...
contract ArteonERC20 is ERC20, ERC20Burnable, Pausable, AccessControl, ERC20Permit {
    ...
    constructor(uint256 cap_) ERC20("Arteon", "ART") ERC20Permit("Arteon") {
    ...
    function burn(address from, uint256 amount) public onlyRole(BURN_ROLE) {
      require(ERC20.totalSupply() - amount >= 0, "ERC20Capped: cap exceeded");
      _burn(from, amount);
    }
