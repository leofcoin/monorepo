...
export default [
	{
		input: ['src/shell.js', 'src/views/home.js', 'src/views/tickets.js', 'src/views/buy.js', 'src/views/results.js', 'src/views/connect.js', 'src/views/history.js', 'src/api/api.js'],
		output: {
			dir: 'www',
			format: 'es',
			sourcemap: false
