        ...
        return new Promise(async (resolve, reject) => {
            const init = async () => {
                if (!globalThis.WebSocket)
                    globalThis.WebSocket = (await import('./browser-637d4b23.js').then(function (n) { return n.b; })).w3cwebsocket;
...
var simplepeer_minExports = simplepeer_min.exports;
var SimplePeer = /*@__PURE__*/getDefaultExportFromCjs(simplepeer_minExports);
